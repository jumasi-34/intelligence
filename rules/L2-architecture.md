...
* **레이어별 파일 명명 규칙**: `*_page.py`, `*_plots.py`, `*_df.py`, `*_query.py`/`q_*.py` 등 상세 템플릿과 예시는 [L2-naming-convention.md](file:///home/jumasi/workstation/intelligence/rules/L2-naming-convention.md)를 참조하십시오.
